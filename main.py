...
INLINE_SELECT = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("ʀᴇᴘᴏ", url="https://github.com/Lukymura/KymuraUploaderBot"),
            InlineKeyboardButton("ʀᴇᴘᴏʀᴛ ʙᴜɢs", url="https://t.me/KyMuraa")
        ],
        [
            InlineKeyboardButton("ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ", url="https://t.me/Kyyomasaa")
            InlineKeyboardButton("ʙᴏᴄɪʟ ʟᴜᴋʏ", url="https:// t.mr/Ayyaaaxn")
        ]
    ]
)
...
ERROR_BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("ʀᴇᴘᴏʀᴛ ʙᴜɢs", url="https://t.me/KyMuraa"),
            InlineKeyboardButton("ʟᴇᴀʀɴ ʙᴏᴛ", url="https://t.me/KyMuraa")
        ]
    ]
)
...
async def start(bot, message):
    text = f"Hello {message.from_user.first_name}!\n\nWelcome to the Telegraph uploader bot.\nYou can send me any " \
           ...
           f"<a href=https://t.me/KyMuraa>Feel free to leave a feedback</a>"
...
async def photo_upload(bot, message):
    ...
    try:
        ...
        IN_BUTTON = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("ʀᴇᴘᴏ", url="https://github.com/Lukymura"),
                    InlineKeyboardButton("ʀᴇᴘᴏʀᴛ ʙᴜɢs", url="https://t.me/KyMuraa")
                ],
                [
                    InlineKeyboardButton("ʟɪʜᴀᴛ ʜᴀsɪʟ", url=generated_link)
                ]
            ]
        )
    except:
        await msg.edit_text(
            "File must be less than 5mb, please try another file or <a href=https://t.me/KyMuraa>LEARN THIS BOT FIRST!</a>",
        ...
        await t.edit_text(
            f"Link - `{generated_link} `\n\n<a href=https://t.me/KyMuraa>Feel free to leave a feedback</a>",
...
async def sticker_upload(bot, message):
    ...
    try:
        ...
        await msg.edit_text(
            f"❌ This sticker was unable to upload. Please try another file or <a href=https://t.me/KyMuraa>LEARN THIS BOT FIRST!</a>\n\n<i>Caused error - {a}</i>",
            reply_markup=INLINE_SELECT,
            disable_web_page_preview=True)
    else:
        t = await msg.edit_text(generated_link, disable_web_page_preview=True)
